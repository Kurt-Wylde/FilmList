...
//{
//    public class func getMockData() -> [WatchedItem]
//    {
//        return [
//            WatchedItem(title: ""),
//            WatchedItem(title: ""),
...
//extension Collection where Iterator.Element == WatchedItem
//{
...
//            create: true)
//        
//        return url?.appendingPathComponent("watcheditems.bin")
//    }
//    
...
//    static func readFromPersistence() throws -> [WatchedItem]
//    {
//        if let url = persistencePath(), let data = (try Data(contentsOf: url) as Data?)
//        {
//            if let array = NSKeyedUnarchiver.unarchiveObject(with: data) as? [WatchedItem]
//            {
//                return array
//            }
//            else
