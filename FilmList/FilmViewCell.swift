...
class FilmViewCell: UITableViewCell, UITextFieldDelegate {
    ...
    override init(style: UITableViewCellStyle,
        ...
        let recognizer = UIPanGestureRecognizer(target: self, action: #selector(FilmViewCell.handlePan(recognizer:)))
